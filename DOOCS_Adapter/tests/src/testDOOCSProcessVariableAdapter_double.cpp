...
struct CallbacksTestFixture {
	...
	unsigned int _set_cb_counter_equals;
            ...
            {
                myddouble     = new myD_double ( NULL, NULL );
                doocs_adapter = new mtca4u::DOOCSPVAdapter<double, myD_double> (myddouble);
            }
	...
	void	reset_counters()
            ...
            // callbacks
	double	on_get_callback ()	                                             //~  < double () >
			{
				++_get_cb_counter;
				return 0;
			}
	void	on_set_callback (double const & newValue, double const & oldValue) //~  < void (double const &, double const & ) >
			{
...
BOOST_AUTO_TEST_CASE( test_get_cb_count )
{
    ...
    myddouble->setOnGetCallbackFunction(boost::bind (&CallbacksTestFixture::on_get_callback, this));
    ...
    myddouble->clearOnGetCallbackFunction();
...
BOOST_AUTO_TEST_CASE( test_set_cb_count )
{
    ...
    myddouble->setOnSetCallbackFunction(boost::bind (&CallbacksTestFixture::on_set_callback, this, _1, _2));
    ...
    myddouble->clearOnSetCallbackFunction();
...
BOOST_AUTO_TEST_CASE( test_sync1 )
{
    ...
    BOOST_CHECK( myddouble    ->value() == 0 );


    doocs_adapter->set(1);
    BOOST_CHECK( doocs_adapter->get  () == 1 );
    BOOST_CHECK( myddouble    ->value() == 1 );  // <---

    doocs_adapter->set(0);
    BOOST_CHECK( doocs_adapter->get  () == 0 );
    BOOST_CHECK( myddouble    ->value() == 0 );  // <---

    myddouble->set_value(3);
    BOOST_CHECK( myddouble    ->value() == 3 );
    BOOST_CHECK( doocs_adapter->get  () == 3 );  // <---

    myddouble->set_value(0);
    BOOST_CHECK( myddouble    ->value() == 0 );
    BOOST_CHECK( doocs_adapter->get  () == 0 );  // <---
...
BOOST_AUTO_TEST_CASE( test_get_nocb_count )
{
    ...
    myddouble    ->value_without_callback();
    BOOST_CHECK( _get_cb_counter        == 0 );
...
BOOST_AUTO_TEST_CASE( test_set_nocb_count )
{
    ...
    myddouble    ->set_value_without_callback(1);
    BOOST_CHECK( _set_cb_counter        == 0 );
    BOOST_CHECK( _set_cb_counter_equals == 0 );
...
struct InterPVTestFixture {         // for testing interactions between two PVs,
    ...
    myD_double                                 * myddouble1;
    myD_double                                 * myddouble2;
	...
	unsigned int _set_cb_counter_equals2;
            ...
            {
                myddouble1     = new myD_double ( NULL, NULL );
                myddouble2     = new myD_double ( NULL, NULL );
                doocs_adapter1 = new mtca4u::DOOCSPVAdapter<double, myD_double> (myddouble1);
                doocs_adapter2 = new mtca4u::DOOCSPVAdapter<double, myD_double> (myddouble2);
            }
	...
	void	reset_counters()
            ...
            // callbacks
            // set 1
	double  on_get_callback1 ()	                                              //~  < double () >
			{
				++_get_cb_counter1;
				return 0;
			}
	void	on_set_callback1 (double const & newValue, double const & oldValue) //~  < void (double const &, double const & ) >
			{
				if (newValue == oldValue) ++_set_cb_counter_equals1;
				++_set_cb_counter1;
			}
            // set 2 (NOTE: different treating of counters!)
	double	on_get_callback2 ()	                                              //~  < double () >
			{
				_get_cb_counter2 += 2;
				return 0;
			}
	void	on_set_callback2 (double const & newValue, double const & oldValue) //~  < void (double const &, double const & ) >
			{
...
BOOST_AUTO_TEST_CASE( set_from_other_pv__callbacks_assignment ) // or rather for no assignment
{
    ...
    doocs_adapter1->set(1);                         // do some random get/set(double) ...
    ...
    doocs_adapter1->set(1);                         // do some random get/set(double) again ...
    doocs_adapter1->setWithoutCallback(1);
    doocs_adapter1->get();
    doocs_adapter1->getWithoutCallback();
    doocs_adapter2->set(1);
...
BOOST_FIXTURE_TEST_SUITE( assign_from_double, InterPVTestFixture )

BOOST_AUTO_TEST_CASE( assign_from_double__checking_operation )
{
    // -- given -- 
    reset_counters();
    doocs_adapter2->setWithoutCallback(0);
...
BOOST_AUTO_TEST_CASE( assign_from_double__callbacks_operation )
{
    // -- given -- 
    reset_counters();
...
BOOST_AUTO_TEST_CASE( assign_from_double__callbacks_assignment ) // or rather for no assignment
{
    // -- given -- 
    reset_counters();
    ...
    doocs_adapter2->set(1);                         // do some random get/set(double) ...
    doocs_adapter2->setWithoutCallback(1);
    doocs_adapter2->get();
    doocs_adapter2->getWithoutCallback();
    ...
    *doocs_adapter2 = 5;
    ...
    // -- then --
    BOOST_CHECK( _get_cb_counter2        == 2 );    // counters state after set(double)
    BOOST_CHECK( _set_cb_counter2        == 2 );    // <---

    doocs_adapter2->set(1);                         // do some random get/set(double) again ...
    doocs_adapter2->setWithoutCallback(1);
    doocs_adapter2->get();
    doocs_adapter2->getWithoutCallback();

...
struct CallbacksTestFixture {
	...
	unsigned int _set_cb_counter_equals;
            ...
            {
                mydtype       = new myD_int ( NULL, NULL );
                doocs_adapter = new mtca4u::DOOCSPVAdapter<int, myD_int> (mydtype);
            }
...
struct InterPVTestFixture {         // for testing interactions between two PVs,
	...
	unsigned int _set_cb_counter_equals2;
            ...
            {
                mydtype1       = new myD_int ( NULL, NULL );
                mydtype2       = new myD_int ( NULL, NULL );
                doocs_adapter1 = new mtca4u::DOOCSPVAdapter<int, myD_int> (mydtype1);
                doocs_adapter2 = new mtca4u::DOOCSPVAdapter<int, myD_int> (mydtype2);
            }

...
struct CallbacksTestFixture {
    ...
    mtca4u::DOOCSPVAdapter<int, m4uD_int> * doocs_adapter;
    m4uD_int                              * mydtype;
	...
	unsigned int _set_cb_counter_equals;
                                     ...
                                     _set_cb_counter_equals(0)
            {
                ...
                doocs_adapter = new mtca4u::DOOCSPVAdapter<int, m4uD_int> (mydtype);
            }
...
struct InterPVTestFixture {         // for testing interactions between two PVs,
    ...
    mtca4u::DOOCSPVAdapter<int, m4uD_int> * doocs_adapter1;
    mtca4u::DOOCSPVAdapter<int, m4uD_int> * doocs_adapter2;
	...
	unsigned int _set_cb_counter_equals2;
            ...
            {
                mydtype1       = new m4uD_int ( NULL, NULL );
                mydtype2       = new m4uD_int ( NULL, NULL );
                doocs_adapter1 = new mtca4u::DOOCSPVAdapter<int, m4uD_int> (mydtype1);
                doocs_adapter2 = new mtca4u::DOOCSPVAdapter<int, m4uD_int> (mydtype2);
            }
